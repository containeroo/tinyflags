...
func (g *Group) String(field, usage string) *ScalarFlag[string] {
	return defineDynamicScalar(g, field, utils.ParseString, utils.FormatString)
}
...
func (g *Group) Float64(field, usage string) *ScalarFlag[float64] {
	return defineDynamicScalar(g, field, utils.ParseFloat64, utils.FormatFloat64)
}

// Float32
func (g *Group) Float32(field, usage string) *ScalarFlag[float32] {
	return defineDynamicScalar(g, field, utils.ParseFloat32, utils.FormatFloat32)
}

// TCPAddr
func (g *Group) TCPAddr(field, usage string) *ScalarFlag[*net.TCPAddr] {
	return defineDynamicScalar(g, field, utils.ParseTCPAddr, utils.FormatTCPAddr)
}

// URL
func (g *Group) URL(field, usage string) *ScalarFlag[*url.URL] {
	return defineDynamicScalar(g, field, url.Parse, func(u *url.URL) string { return u.String() })
}

// File
func (g *Group) File(field, usage string) *ScalarFlag[*os.File] {
	return defineDynamicScalar(g, field, utils.ParseFile, utils.FormatFile)
}

// Time
func (g *Group) Time(field, usage string) *ScalarFlag[time.Time] {
	return defineDynamicScalar(g, field, utils.ParseTime, utils.FormatTime)
}

// Bytes
func (g *Group) Bytes(field, usage string) *ScalarFlag[uint64] {
	return defineDynamicScalar(g, field, utils.ParseBytes, utils.FormatBytes)
}
